# BowersBondingCurveFA2.py
# FA2 with bonding-curve minting: price = base_price + (minted / step_size) * price_increment.
# Admin creates token factories; public mints at computed price. Full marketplace (listings, offers, buy, blacklist, withdraw).
...
def main():
    ...
    class BowersBondingCurveFA2(sp.Contract):
...
@sp.add_test()
def test():
    scenario = sp.test_scenario("BowersBondingCurveFA2", main)
